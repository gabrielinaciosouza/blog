...
class PostTest {
    ...
    void shouldCreateCorrectToString() {
        ...
        assertEquals("Post {\"content\":\"Content {\\\"value\\\":\\\"any content\\\"}\",\"creationDate\":\"CreationDate {\\\"value\\\":\\\""+ creationDate.getValue() +"\\\"}\",\"title\":\"Title {\\\"value\\\":\\\"any title\\\"}\",\"id\":\"Id {\\\"value\\\":\\\"any id\\\"}\"}", post.toString());
    }
}
