...
public class UserFixture {
  ...
  public static class UserBuilder {
    ...
    public UserBuilder withId(final Id id) {
      this.id = id;
      return this;
    }
    ...
    public UserBuilder withRole(final User.Role role) {
      this.role = role;
      return this;
    }

    public UserBuilder withName(final Name name) {
      this.name = name;
      return this;
    }

    public UserBuilder withImage(final Image image) {
      this.image = image;
      return this;
    }
