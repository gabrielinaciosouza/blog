...
/**
 * The {@link GetDeletedPostsUseCase} class represents the use case for retrieving deleted posts.
 *
 ...
 */
@ApplicationScoped
public class GetDeletedPostsUseCase {

  private final PostRepository postRepository;

  /**
   * Creates a new {@link GetDeletedPostsUseCase} with the specified post repository.
   *
   * @param postRepository the post repository to use for managing post data.
   */
  public GetDeletedPostsUseCase(final PostRepository postRepository) {
