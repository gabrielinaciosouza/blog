...
describe('AuthLinks', () => {
    ...
    it('should render admin and logout links when status is authenticated', () => {
    ...
    it('should render admin and logout links in responsive menu when status is authenticated', () => {
        render(<AuthLinks authStatus="authenticated" />);
