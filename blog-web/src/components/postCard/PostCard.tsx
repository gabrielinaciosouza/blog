...
const PostCard = (post: Post) => {
    ...
    return (
        <Link href={`/posts/${post.slug}`} className="block group">
            <Card className="flex flex-col overflow-hidden rounded-2xl shadow-lg bg-background transition-all duration-200 w-80 mx-auto border border-border hover:shadow-2xl hover:scale-105 p-2">
